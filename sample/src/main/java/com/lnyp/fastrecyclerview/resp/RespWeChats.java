package com.lnyp.fastrecyclerview.resp;
...
public class RespWeChats {
    ...
    public static class ResultEntity {
        ...
        public void setList(List<WeChatModel> list) {
            this.list = list;
        }
        ...
        public List<WeChatModel> getList() {
            return list;
        }
