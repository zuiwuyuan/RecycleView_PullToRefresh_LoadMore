 ...
 * 瀑布流
 */
public class WChatStaggeredActivity extends AppCompatActivity {
            ...
            public void getIOAuthCallBack(int code, String result) {
                switch (code) {
                    case 200:
                        ...
                        break;
                    case 400:
                        RecyclerViewStateUtils.setFooterViewState(WChatStaggeredActivity.this, listWeChats, PAGE_SIZE, RecyclerViewLoadingFooter.State.NetWorkError, mFooterClick);
                        break;
                }
...
//        weChatListAdapter.notifyDataSetChanged();
    ...
    private EndlessRecyclerOnScrollListener mOnScrollListener = new EndlessRecyclerOnScrollListener() {
        ...
        public void onLoadNextPage(View view) {
            ...
            if (hasMore) {
                RecyclerViewStateUtils.setFooterViewState(WChatStaggeredActivity.this, listWeChats, PAGE_SIZE, RecyclerViewLoadingFooter.State.Loading, null);
                qrrDataFromServer();

            } else {
                RecyclerViewStateUtils.setFooterViewState(WChatStaggeredActivity.this, listWeChats, PAGE_SIZE, RecyclerViewLoadingFooter.State.TheEnd, null);
            }
        }
    };
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            try {
                ...
                Toast.makeText(WChatStaggeredActivity.this, "pos : " + pos, Toast.LENGTH_SHORT).show();
